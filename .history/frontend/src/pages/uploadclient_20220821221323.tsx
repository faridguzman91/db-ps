            ...
            <div className="hero-content text-center text-neutral-content">
                ...
                <div className="card w-100 h-1/4 glass">
                    ...
                    <div className="card-body h-88 w-88">
                        ...
                        <div className="form-control w-full max-w-xs justify-between flex flex-column">

                            <label className="label">
                                <span className="label-text px-2 mr-2">Email</span>
                            </label>

                            <input type="text" value="email" placeholder="Type email" className="input input-bordered w-full max-w-xs px-2 mr-2" />
